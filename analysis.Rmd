...
path_to_repo_folder <- "~/Dropbox (MIT)/" # replace "cogsci21" with your repo folder name
project.path <- paste(path_to_repo_folder, "cogsci21/data/", sep = "")
...
df_game_summary_edit %>%
  ...
  ungroup() %>%
  mutate(key = factor(key, levels = c("edit_distance", "diff_add_count", "diff_del_count"),
